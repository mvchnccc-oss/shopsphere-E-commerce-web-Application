    ...
    <main className="min-h-screen bg-background xl:pt-6">
        ...
        <div className="relative w-full px-4 py-24 flex flex-col items-center text-center gap-6">
          ...
          <div className="flex flex-wrap gap-1 justify-center">
            <Button
              asChild
              size="lg"
              className="bg-white text-emerald-500 hover:bg-emerald-700 hover:text-white hover:border-white font-bold shadow-lg"
            >
              <Link href="/products">
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-4 text-white/80 text-sm">
            <span className="flex items-center gap-1.5">
              <TruckIcon className="size-4" /> Free shipping over 1000 EGP
            </span>
            <span className="flex items-center gap-1.5">
              <ShieldCheckIcon className="size-4" /> Secure checkout
            </span>
            <span className="flex items-center gap-1.5">
              <ShoppingBagIcon className="size-4" /> Easy returns
            </span>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            href="/products"
            className="flex items-center gap-1 text-emerald-600 dark:text-emerald-400 text-sm font-semibold hover:underline"
          >
