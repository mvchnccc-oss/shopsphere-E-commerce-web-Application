...
import type { Products, Product } from "@/Interfaces/productsinterface";
                    ...
                    >
                        <CarouselContent className="-ml-2">
                            {products.map((product, index) => (
                                <CarouselItem key={`${category}-${product._id}-${index}`} className="pl-2 sm:basis-1/2 md:basis-1/3 lg:basis-1/4 xl:basis-1/5 basis-full">
